...
description: "Research your competitors extensively and generate an interactive HTML battlecard can use in deals. The output is a self-contained artifact with clickable competitor tabs an..."
---

# Competitive Intelligence

Research your competitors extensively and generate an **interactive HTML battlecard** can use in deals. The output is a self-contained artifact with clickable competitor tabs and an overall comparison matrix.
...
├─────────────────────────────────────────────────────────────────┤
│  SUPERCHARGED (when the agent connects your tools)                      │
...
**Optional:**
- Which competitor do the user wants to focus on first?
