---
name: daily-briefing
description: "Get a clear view of what matters most today. Works with whatever context is provided, and gets richer when sales, calendar, and CRM tools are connected. Use when the user asks to 'prepare my day', 'daily briefing', 'morning summary', 'what should I focus on today', 'daily sales plan', or 'prioritize my day'."
---

# Daily Sales Briefing

Get a clear view of what matters most today. This skill works with whatever you tell me, and gets richer when the agent connects your tools.
